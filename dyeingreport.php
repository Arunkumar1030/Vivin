...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
   ...
   <div class="col-lg-12">
     <div class="card">
       <div class="card-header">dyeing Process Report
...
?>
        ...
        <td><a href="dyeingupdate.php?productid=<?php echo $data['product id']; ?>"><i class="fa fa-edit"></i>Edit</a><br>
          <a href="dyeingaddcolor.php?batchid=<?php echo $data['batchid']; ?>"><i class="fa fa-edit"></i>Add color</a><br>
          <a href="dyeingdelete.php?productid=<?php echo $data['product id']; ?>"><i class="fa fa-trash"></i>Delete</a></td>
      <tr>
<?php
    $sn++;
  }
