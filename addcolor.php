  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Colors Add Form</div>
           <hr>
            <form action="" method="post" autocomplete="off">
           <div class="form-group">
            <label for="input-1">Color ID</label>
            <input type="Number" min="1" class="form-control" id="input-1" placeholder="Enter Batch ID" name="colorid">
           </div>
           <div class="form-group">
            <label for="input-2">Color</label>
            <input type="text" class="form-control" id="input-2" placeholder="Enter Color" name="color">
           </div>
...
{    
  ...
  $color = $_POST["color"];
     $sql = "INSERT INTO color (colorid,color)
     VALUES ('$colorid','$color')";
...
<br>
   ...
   <div class="col-lg-6">
     <div class="card">
       <div class="card-header">Color Report
...
if (mysqli_num_rows($result) > 0) {
 ...
 ?>
                   <tbody><tr>
   <td><?php echo $data['colorid']; ?> </td>
   <td><?php echo $data['color']; ?> </td>
 
  
   <td><a  href="updatecolor.php?colorid=<?php echo $data['colorid'];?>"><i class="fa fa-edit"></i>Edit</a><br><a href="deletecolor.php?colorid=<?php echo $data['colorid'];?>"><i class="fa fa-trash"></i>Delete</a></td>
 <tr>
 <?php
  $sn++;}} else { ?>
    <tr>
