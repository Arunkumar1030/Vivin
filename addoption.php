  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Add Option Form</div>
           <hr>
               <button   class="btn btn-light px-5" onclick="window.location.href = 'addcolor.php';"><i class="icon-menu"></i>Add Color</button>
                <button   class="btn btn-light px-5" onclick="window.location.href = 'addmaterial.php';"><i class="icon-menu"></i>Add Material</button>           
         </div>
         </div>
      </div>
