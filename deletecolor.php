...
$sql = "DELETE FROM color WHERE colorid='" . $_GET["colorid"] . "'";
...
<br>
         ...
         <button type="submit" value="reportpage" name="reportpage" class="btn btn-light px-5" onclick="window.location.href = 'addcolor.php';"><i class="icon-menu"></i>Back</button> 
