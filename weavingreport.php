...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
   ...
   <div class="col-lg-12">
     <div class="card">
       <div class="card-header">Weaving Process Report
...
if (mysqli_num_rows($result) > 0) {
 ...
 ?>
   ...
   <td><a  href="weavingupdate.php?batchid=<?php echo $data['batchid'];?>"><i class="fa fa-edit"></i>Edit</a><br><a href="weavingdelete.php?batchid=<?php echo $data['batchid'];?>"><i class="fa fa-trash"></i>Delete</a></td>
 <tr>
 <?php
  $sn++;}} else { ?>
    <tr>
