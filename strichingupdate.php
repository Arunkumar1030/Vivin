...
$sql = "SELECT * FROM `striching` WHERE `product id` = $productid";
  ...
  <div class="col-lg-7">
         <div class="card">
           ...
           <div class="form-group">
            ...
            <select  class="form-control" id="input-3" placeholder="<?php echo $color;?>" name="color">
              <option  class="form-control" id="input-3"  hidden><?php echo $color;?></option>
           ...
           <div class="form-group">
            ...
            <select  class="form-control" id="input-3" placeholder="<?php echo $material;?>" name="material">
              <option  class="form-control" id="input-3"  hidden><?php echo $material;?></option>
          ...
          <div class="form-group">
            <label for="input-3">Size</label>
             <select  class="form-control" id="input-3" placeholder="<?php echo $size;?>" name="size">
              <option  class="form-control" id="input-3"  hidden><?php echo $size;?></option>
              <option>S</option>
              <option>M</option>
              <option>L</option>
              <option>XL</option>
...
if (isset($_POST['submit'])) {
   ...
   if (empty($batchid)   || empty($qty)  || empty($startdate) || empty($enddate) || empty($status)) {
      ...
      // Update the database table
        ...
        $result = mysqli_query($conn, "UPDATE `striching` SET `batchid` = $batchid,`material` = '$material',`color` = '$color',`size` = '$size', `process` = 'striching', `qty` = '$qty', `scale` = 'pieces', `startdate` = '$startdate', `enddate` = '$enddate', `status` = '$status' WHERE `product id` = $productid");
