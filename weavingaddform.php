  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-7">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Weaving Add Form</div>
           <hr>
...
{    
  ...
  $startdate = $_POST["startdate"];
     $sql = "INSERT INTO weaving (batchid,process,material,qty,scale, startdate,enddate,status)
     VALUES ('$batchid','weaving', 'dress', '$qty', 'meter', '$startdate','','On Process')";
...
<br><br>
         ...
         <button type="submit" value="reportpage" name="reportpage" class="btn btn-light px-5" onclick="window.location.href = 'weavingreport.php';"><i class="icon-menu"></i>Go Report Page</button> 
