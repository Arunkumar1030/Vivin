...
$sql = "DELETE FROM material WHERE materialid='" . $_GET["materialid"] . "'";
...
<br>
         ...
         <button type="submit" value="reportpage" name="reportpage" class="btn btn-light px-5" onclick="window.location.href = 'addmaterial.php';"><i class="icon-menu"></i>Back</button> 
